const DATA = {
  ...
  ccActual: {
    "טיולים":      { actual:1331, target:0,    note:"אל-על, בוקינג, מלונות בחו\"ל — ממוצע אמיתי (לא כולל שבט רמון/מט\"ח)" },
    "מכולות":      { actual:5500, target:5000, note:"אושר עד, רמי לוי, שופרסל — Amex ₪2,432 + CAL ₪3,068" },
    ...
    "דלק":         { actual:1500, target:1500, note:"פז, דלק — Amex ₪380 + CAL ₪1,120 (מכונית אחת, קטיה לעבודה)" },
    ...
    "AliExpress/אונליין": { actual:0, target:200, note:"לא מעוקב — מוסתר ב-PayPal ב-CAL. לזהות חודשי." },
  ...
  monthly: [
    { month:"2025-11", income:30455,
      cc:20500, loans:7911, fixed_costs:2302, kids_costs:2053,
      label:"נוב 25", abroad:false },
    { month:"2025-12", income:36000, bonus:6000,
      cc:19940, loans:7911, fixed_costs:2302, kids_costs:2053,
      label:"דצמ 25", abroad:false },
    { month:"2026-01", income:30079,
      cc:22000, loans:7911, fixed_costs:2302, kids_costs:2053,
      label:"ינו 26",  abroad:true, trip:"קפריסין" },
    { month:"2026-02", income:24898,
      cc:18600, loans:7911, fixed_costs:2302, kids_costs:2053,
      label:"פבר 26", abroad:false },
    { month:"2026-03", income:30788, bonus:3588,
      cc:19100, loans:4032, fixed_costs:2302, kids_costs:2053,
      label:"מרץ 26", abroad:false },
    { month:"2026-04", income:30374,
      cc:21200, loans:4032, fixed_costs:2302, kids_costs:2053,
      label:"אפר 26", abroad:true, trip:"אילת" },
    { month:"2026-05", income:30811,
      cc:20500, loans:4032, fixed_costs:2302, kids_costs:2053,
      label:"מאי 26", abroad:true, trip:"קפריסין" },
    { month:"2026-06", income:30374,
      cc:17800, loans:4032, fixed_costs:2302, kids_costs:2053,
  ...
  overdraft: {
    start: 64000,
    startMonth: "2026-06",
    interestRate: 0.0725, // Prime + 2.75% = 7.25%
    schedule: [
